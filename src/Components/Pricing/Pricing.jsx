    ...
    <div id='pricing'>
      <div className='pricing_card1'>
        <div className='pricing_heading'>
          <h2 >Day Pass</h2>
          <h1 className='pricing_pass'>$20</h1>
          <h2>/pass</h2>
        </div>
        <ul >
          <li>
        ...
        <button className='pricing_btn' onClick={() => alert('Thanks for Choosing Us!')}>Get Started</button>
      </div>
      ...
      <div>
        <div className='pricing_card2'>
          <div className='pricing_heading'>
            ...
            <h1 className='pricing_pass'>$90</h1>
            <h2>/month</h2>
          </div>
          <ul >
            <li>
              <span><AiOutlineCheckCircle className='pricing_check2' />$ 99 Joining Fee</span>
            </li>
            <li>
          ...
          <button className='pricing_btn2' onClick={() => alert('Thanks for Choosing Us!')}>Get Started</button>
        </div>
      </div>
